...
public class TextManager_2 : MonoBehaviour
{
    ...
    {
        string jsonPath = Path.Combine(Application.streamingAssetsPath, "chapter2_data.json");
    ...
    private void ShowNextDialogue()
    {
        ...
        {
            Debug.Log("ShowNextDialogue: 会話終了、Chapter3Sceneへ遷移");
            dialogueText.text = "会話終了";
            choicesPanel.SetActive(false);
            SceneManager.LoadScene("Chapter3Scene"); // ← シーン遷移処理
            return;
        }
